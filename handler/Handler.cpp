...
#include "./Block.cpp"
#include "../variables/BigInt.cpp"
#include "../variables/Boolean.cpp"
#include "../variables/Null.cpp"
#include "../variables/Number.cpp"
#include "../variables/String.cpp"
#include "../variables/Undefined.cpp"
...
private:
    VariableType handleLine(Tree& node) {
        if (node.value == "ASSIGN" || node.value == "ASSIGN_PERMANENT") {
            ...
            VariableType variable = handleLine(*node.right);
